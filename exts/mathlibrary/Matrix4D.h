...
Matrix4D::Matrix4D(float x1, float y1, float z1, float w1,
	float x2, float y2, float z2, float w2,
	float x3, float y3, float z3, float w3,
	float x4, float y4, float z4, float w4)
{
...
Matrix4D& Matrix4D::operator*(Vector4D& vec)
{
	float sum = 0;
	Vector4D result;
	for (int n = 0; n < 4; n++) {
...
void Matrix4D::setData(float x1, float y1, float z1, float w1,
	float x2, float y2, float z2, float w2,
	float x3, float y3, float z3, float w3,
	float x4, float y4, float z4, float w4)
{
...
Matrix4D Matrix4D::rotate(float radians)
{
	Matrix4D result;
...
float Matrix4D::getData(int n, int m)
{
	return data[n][m];
}


float* Matrix4D::getDataPtr()
{
